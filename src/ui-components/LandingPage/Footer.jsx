        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-[34fr_19fr_19fr_28fr]">
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <p className="max-w-xs text-muted">
              Powering clean, compliant data infrastructure for the next
              generation of tech products.{" "}
            </p>
            <p className="mt-8 text-sm text-muted-foreground">
              © {new Date().getFullYear()} MTN Data ScrapeX API. All rights
              reserved.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <address className="space-y-4 not-italic text-muted">
              ...
              <a
                href="mailto:admin@mtndata.com"
                className="flex items-center gap-3 transition-colors hover:text-accent"
              >
                <Mail size={18} className="text-accent" />
                <span>admin@mtndata.com</span>
              </a>
