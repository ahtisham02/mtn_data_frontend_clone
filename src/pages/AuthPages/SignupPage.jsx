  ...
  return (
    ...
    >
      <motion.span
        ...
        className={`w-2 h-2 ${bgColorClass} rounded-full`}
      />
      <motion.span
        variants={dotVariants}
        className={`w-2 h-2 ${bgColorClass} rounded-full`}
...
const ValidationItem = ({ isValid, text }) => (
  <motion.div
    ...
    className={`flex items-center gap-2 text-xs transition-colors ${
      isValid ? "text-green-500" : "text-muted"
    }`}
  >
...
const SignupPage = () => {
  ...
  return (
    <AuthLayout
      ...
      welcomeMessage="Create an account to unlock exclusive features and enjoy top-tier security. Plus, get 100 free credits as a welcome gift — on us!"
    >
      <motion.div
      ...
      >
        ...
        <footer className="flex-shrink-0 mt-2">
          ...
          <motion.p
            variants={itemVariants}
            className="mt-6 text-sm text-center text-muted"
          >
